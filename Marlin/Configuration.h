...
#define STRING_CONFIG_H_AUTHOR "(Un disperato Daniele, Hictop Prusa i3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Hictop Prusa i3"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.409, 80.417, 401.935, 98.6 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 120, 120, 2, 25 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 10, 62, 0 } 
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT X_CENTER    // X point for Z homing when homing all axes (G28). X_CENTER Y_CENTER
